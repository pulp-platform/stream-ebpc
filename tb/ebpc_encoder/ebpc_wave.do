...
add wave -noupdate -group {BPC Encoder} -radix decimal -childformat {{{/ebpc_encoder/bpc_encoder_i/data_i[7]} -radix decimal} {{/ebpc_encoder/bpc_encoder_i/data_i[6]} -radix decimal} {{/ebpc_encoder/bpc_encoder_i/data_i[5]} -radix decimal} {{/ebpc_encoder/bpc_encoder_i/data_i[4]} -radix decimal} {{/ebpc_encoder/bpc_encoder_i/data_i[3]} -radix decimal} {{/ebpc_encoder/bpc_encoder_i/data_i[2]} -radix decimal} {{/ebpc_encoder/bpc_encoder_i/data_i[1]} -radix decimal} {{/ebpc_encoder/bpc_encoder_i/data_i[0]} -radix decimal}} -subitemconfig {{/ebpc_encoder/bpc_encoder_i/data_i[7]} {-height 16 -radix decimal} {/ebpc_encoder/bpc_encoder_i/data_i[6]} {-height 16 -radix decimal} {/ebpc_encoder/bpc_encoder_i/data_i[5]} {-height 16 -radix decimal} {/ebpc_encoder/bpc_encoder_i/data_i[4]} {-height 16 -radix decimal} {/ebpc_encoder/bpc_encoder_i/data_i[3]} {-height 16 -radix decimal} {/ebpc_encoder/bpc_encoder_i/data_i[2]} {-height 16 -radix decimal} {/ebpc_encoder/bpc_encoder_i/data_i[1]} {-height 16 -radix decimal} {/ebpc_encoder/bpc_encoder_i/data_i[0]} {-height 16 -radix decimal}} /ebpc_encoder/bpc_encoder_i/data_i
...
add wave -noupdate -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/dbx
...
WaveRestoreCursors {{Cursor 1} {973403 ps} 0} {Trace {156744433 ps} 0}
...
update
WaveRestoreZoom {617420508 ps} {625156741 ps}
