...
add wave -noupdate -expand -group Top /ebpc_encoder/bpc_data_o
...
add wave -noupdate -expand -group {BPC Encoder} -radix decimal /ebpc_encoder/bpc_encoder_i/data_i
...
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/data_i
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/flush_i
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/vld_i
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/rdy_o
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/vld_o
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/rdy_i
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/idle_o
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} -radix decimal /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/diffs_d
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} -radix decimal /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/diffs_q
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/last_item_d
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/last_item_q
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/state_d
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/state_q
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/fill_cnt_d
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/fill_cnt_q
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/shift
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} -radix binary /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/dbp
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/dbx
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/flush_d
add wave -noupdate -expand -group {BPC Encoder} -group {DBP DBX Enc} /ebpc_encoder/bpc_encoder_i/dbp_dbx_i/flush_q
...
WaveRestoreCursors {{Cursor 1} {25091750 ps} 0}
...
update
WaveRestoreZoom {24991428 ps} {25174832 ps}
